      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center border-t border-[rgb(var(--border-primary))] mt-8 pt-6">
          ...
          <div className="flex flex-col justify-center space-x-6 text-sm text-[var(--text-muted)]">
            ...
            <span className="text-lg mt-3">Built with ❤️ by <a href="https://facebook.com/forhadhossain.me" className="!text-blue-600 font-bold underline">Forhad (CSE&apos;23)</a></span>
          </div>
        </div>
      </div>
    </footer>
